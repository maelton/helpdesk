...
(
    ...
    CONSTRAINT pk_tb_sla_priority PRIMARY KEY (id),
...
(
    ...
    created_at          TIMESTAMP WITHOUT TIME ZONE,
    updated_at          TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_tb_sla_calendar PRIMARY KEY (id),
...
(
    ...
    created_at      TIMESTAMP WITHOUT TIME ZONE,
    updated_at      TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_tb_sla_day PRIMARY KEY (id),
...
(
    ...
    created_at      TIMESTAMP WITHOUT TIME ZONE,
    updated_at      TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_tb_sla_exception PRIMARY KEY (id),
